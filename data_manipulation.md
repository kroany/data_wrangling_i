...
look for more than two pups alive, more than or equal to, less than or
equal to…
...
Learning Assessment: In the pups data: Filter to include only pups with
...
create wt_gain variable make all results under group variable lowercase
