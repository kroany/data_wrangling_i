...
Update the names in ‘litters_df’ Clean things up, remove spaces and
replace with underscore, no @ symbols, etc
...
remove the first 3 rows, variables row is not on top clean variable
names
...
Import the PULSE data coverts all variables to start with bdi
